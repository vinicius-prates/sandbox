...
export const BlackNavBar = () => {
    ...
    return(
        ...
        <div >
			   <nav className="relative px-4 py-4 flex justify-between items-center bg-[#252525] w-full">
		<Link to="/"  className="text-3xl text-white font-bold leading-none  select-none">
			EXOBANK
		</Link>
		<div  className="lg:hidden">
			<button onClick={toggleMenu}  className="navbar-burger flex items-center text-white p-2 ">
		...
		<ul  className="mobile-menu lg:mt-0 mt-[25rem] ml-0 bg-white w-[90%]  h-[40rem]	justify-center
		 ...
		 lg:gap-0 lg:flex-row lg:h-0  ">
			<li><Link to="/"  className="text-lg lg:text-lg text-blue-600 font-bold hover:text-gray-200 border-b-2 duration-300 select-none" >Home</Link></li>
		
			<li><Link to="#aboutexo"  className="text-lg  text-blue-600 hover:text-gray-200 font-bold border-b-2 duration-300 select-none" >About Exo</Link></li>
			
			<li><a  className="text-lg  text-blue-600 hover:text-gray-200 font-bold border-b-2  duration-300 select-none" href="#">Services</a></li>
		
			<li><a  className="text-lg  text-blue-600 hover:text-gray-200 font-bold border-b-2 duration-300  select-none" href="#">For you</a></li>
			
			<li><a  className="text-lg  text-blue-600 hover:text-gray-200 font-bold border-b-2 duration-300  select-none" href="#">Contact</a></li>
		</ul>
