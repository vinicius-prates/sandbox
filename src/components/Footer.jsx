        ...
        <div className="bg-[#373737] w-full mb-0 flex flex-col p-16 gap-4 lg:flex-row lg:px-96">
            ...
            <div>
                ...
                <div className="flex gap-2">
                    <img src="https://img.icons8.com/666666/ios11/2x/github.png" className="w-[2.5rem] "/>
                    <img src="https://img.icons8.com/666666/ios11/2x/linkedin-circled.png" className="w-[2.5rem]  "/>
                    <img src="https://img.icons8.com/666666/ios11/2x/instagram-circle.png" className="w-[2.5rem]" />
