    ...
    return(
        ...
        <div className="bg-[#1B4372] bg-cover h-full flex flex-col p-6 gap-12 lg:flex-row lg:space-content-evenly lg:py-10 lg:px-[20rem] ">
            ...
            <div className=" flex flex-col gap-10 lg:w-[50%] justify-center">
                ...
                <p className="text-white font-thin tracking-wide">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer sit amet leo lectus.
                 ...
                 Phasellus in felis sed libero sagittis consequat. Curabitur et tellus turpis. Integer mattis odio ex,
                  ...
                  <a  className="block px-4 py-3 mb-2 leading-loose text-xl text-center text-white text-lg font-semibold bg-black   hover:bg-blue-700  rounded-2xl transition duration-200" href="#">More Info</a>
            </div>
        </div>
        </>
    )
