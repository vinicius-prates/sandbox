    ...
    return(
		...
		<ul  className="mobile-menu lg:mt-0 mt-[25rem] ml-0 bg-white w-[90%]  h-[40rem]	justify-center
		 ...
		 lg:gap-0 lg:flex-row lg:h-0  ">
			<li><Link to="/"  className="text-lg  text-gray-800 font-bold hover:text-gray-500 border-b-2  select-none" >Home</Link></li>
		
			<li><Link to="#aboutexo"  className="text-lg  text-gray-800 hover:text-gray-500 font-bold border-b-2 duration-300 select-none" >About Exo</Link></li>
			
			<li><Link to="/cards" className="text-lg  text-gray-800 hover:text-gray-500 font-bold border-b-2  duration-300 select-none" href="#">Cards</Link></li>
		
			<li><a  className="text-lg  text-gray-800 hover:text-gray-500 font-bold border-b-2 duration-300  select-none" href="#">For you</a></li>
			
			<li><a  className="text-lg  text-gray-800 hover:text-gray-500 font-bold border-b-2 duration-300  select-none" href="#">Contact</a></li>
		</ul>
