...
export const CardsPage = () => {
    ...
    return(
        <>
        <BlackNavBar/>
        <h1 className="text-white bg-[#252525] text-center py-2 text-4xl">3 Types of Cards!</h1>

        <div className="bg-[#252525] flex flex-col text-center py-12 gap-8 lg:flex-row">
